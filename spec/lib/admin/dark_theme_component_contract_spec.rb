...
RSpec.describe "Contrato dark dos componentes compartilhados do admin" do
  ...
  it "mantem avatares com imagem e fallback em tamanhos compartilhados" do
    ...
    expect(avatar_view).to include("image_tag(", 'role="img"', "aria-label=\"<%= name %>\"", "<%= initials %>", "image-fallback")
    expect(avatar_stylesheet).to include(".ax-avatar__image", ".ax-avatar.is-image-missing .ax-avatar__image")
