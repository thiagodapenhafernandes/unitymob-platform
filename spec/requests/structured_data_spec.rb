...
RSpec.describe "Structured data", type: :request do
  ...
  it "renders the RealEstateAgent JSON-LD on the home page" do
    LayoutSetting.instance(tenant: Tenant.public_for).update!(site_name: "Salute Imóveis")
    ContactSetting.instance(tenant: Tenant.public_for).update!(address: "Avenida Brasil, 1000")
