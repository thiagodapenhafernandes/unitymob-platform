...
RSpec.describe "Admin::Captacoes dashboard", type: :request do
  ...
  it "calcula metas e indicadores de captação a partir dos imóveis" do
    ...
    create(:habitation, :broker_intake, tenant:, codigo: "CAP-DASH-#{SecureRandom.hex(4)}", admin_user: dashboard_admin, intake_status: "internal", admin_reviewed_at: effective_at, valor_venda_cents: 0, valor_locacao_cents: 4_000_00, regiao_foco: "Sim", rental_management_flag: true)
    create(:habitation, :broker_intake, tenant:, codigo: "CAP-DASH-#{SecureRandom.hex(4)}", admin_user: dashboard_admin, intake_status: "published", admin_reviewed_at: effective_at, broker_released_at: 1.day.ago, valor_venda_cents: 0, valor_locacao_cents: 3_000_00, regiao_foco: "Não", rental_management_flag: false, exibir_no_site_flag: true)
    create(:habitation, :broker_intake, tenant:, codigo: "CAP-DASH-#{SecureRandom.hex(4)}", admin_user: dashboard_admin, intake_status: "published", admin_reviewed_at: effective_at, valor_venda_cents: 0, valor_locacao_cents: 2_000_00, regiao_foco: "Sim", rental_management_flag: true, exibir_no_site_flag: true)
