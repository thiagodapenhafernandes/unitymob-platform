class HabitationAuditLog < ApplicationRecord
  ...
  FIELD_LABELS = {
    ...
    "valor_alugado_terceiros_cents" => "Valor comercializado (locação)",
    "valor_vendido_terceiros_cents" => "Valor comercializado (venda)",
    ...
    "aceita_parcelamento_flag" => "Aceita parcelamento",
    "home_corporate_flag" => "Vitrine Corporate",
    "key_location" => "Onde estão as chaves",
  ...
  def title
    ...
    when "rental_short_cycle_alert" then "#{actor_name} gerou alerta de locação encerrada em menos de 30 dias"
