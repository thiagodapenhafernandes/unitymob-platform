class Profile < ApplicationRecord
  ...
  RESOURCES = [
    ...
    { key: "dashboard_broker_performance", label: "Performance dos Corretores", icon: "bi-person-lines-fill", actions: %w[view], scopeable: true, description: "Bloco e relatório de ciclo dos leads por corretor no dashboard" },
    { key: "dashboard_campaign_performance", label: "Performance de Campanhas", icon: "bi-signpost-split", actions: %w[view], scopeable: true, description: "Bloco e relatório de campanhas, canais e avanço comercial no dashboard" },
