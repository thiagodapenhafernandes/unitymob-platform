...
export default class extends Controller {
  ...
  previewTemplate(event) {
    ...
    if (this.hasTemplatePreviewTarget) this.templatePreviewTarget.textContent = "Carregando prévia…"
  ...
  renderTemplatePreview(data) {
    ...
    this.templatePreviewTarget.innerHTML = data.preview_html || this.escape(data.body || "Modelo sem corpo")
  }
