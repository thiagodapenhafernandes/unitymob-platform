class BlogController < ApplicationController
  ...
  def index
    @page_name = "blog"
    @page_title = "Blog #{@layout_setting.site_name} | Imóveis e regiões"
    @page_description = "Guias de bairros, dicas para comprar e investir e novidades do mercado imobiliário. Conteúdos da #{@layout_setting.site_name}."
    ...
    prepare_blog_social_image(@articles.detect { |article| article.cover.attached? })
  end
end
