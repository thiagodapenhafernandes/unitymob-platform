      ...
      class LeadsController < BaseController
        ...
        def show
          ...
          render json: {
            ...
            labels: lead.lead_labels.where(tenant_id: grant.tenant_id).limit(30).map { |label| { id: label.id, name: label.name } },
        ...
        def summary(lead)
          { id: lead.id, name: lead.display_name, status: lead.status,
