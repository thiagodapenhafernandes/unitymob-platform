module Admin::ComercialHelper
  ...
  TIMELINE_MAP = {
    ...
    "whatsapp_attendance_opened"      => { icon: "bi-headset",         color: "green", label: "Atendimento WhatsApp iniciado" },
    "whatsapp_attendance_transferred" => { icon: "bi-arrow-left-right", color: "amber", label: "Atendimento WhatsApp transferido" },
    "whatsapp_attendance_unassigned"  => { icon: "bi-exclamation-triangle", color: "red", label: "Atendimento WhatsApp sem atendente" },
    "whatsapp_attendance_finished"    => { icon: "bi-check2-circle",   color: "green", label: "Atendimento WhatsApp finalizado" },
