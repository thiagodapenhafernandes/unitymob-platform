  ...
  class PropertyReconciliationService
    ...
    def update_property!(habitation, api, owner, broker, photos, development_photos)
      ...
      attrs = compact_attrs(
        ...
        proprietario_celular: owner&.mobile_phone.presence || owner&.phone_primary,
        proprietario_telefone_comercial: owner&.business_phone,
        proprietario_telefone_residencial: owner&.residential_phone,
      ...
      attrs.merge!(
        ...
        exibir_no_site_portal_flag: yes?(api["ExibirNoSiteSalute"]),
        destaque_web_flag: yes?(api["DestaqueWeb"]),
        festival_flag: yes?(api["SuperDestaqueWeb"]) || yes?(api["FestivalSalute"]),
        ...
        rental_management_flag: rental_management_flag(api),
    ...
    def local_publication_flag_for(habitation, api)
      ...
      vista_publication_flag(api)
    end

    def vista_publication_flag(api)
      yes?(api["ExibirNoSite"]) || yes?(api["ExibirNoSiteSalute"])
    end
